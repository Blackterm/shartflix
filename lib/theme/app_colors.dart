...
class ThemeColor {
  ...
  static const Color accentDark = Color(0xFF5A5A5A);
  static const Color accentLight = Color(0xFF6A6A6A);
  static const Color lightPrimary = Color(0xffB790FF);
  static const Color lighterPrimary = Color.fromARGB(80, 183, 144, 255);
  static const Color lightestPrimary = Color(0x80EFE5FD);
  ...
  static const Color lightBlue = Color(0xFF297DFE);
